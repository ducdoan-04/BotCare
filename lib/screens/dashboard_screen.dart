...
class DashboardScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: const [
                                      Text('Nola Hawkins', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary, fontSize: 15)),
                                      Text('Receptionist', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                                    ],
                                  ),
                                ],
                              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildStatIndicator('86', 'Under treatment', const Color(0xFF007A8A)),
                        const SizedBox(width: 48),
                        _buildStatIndicator('54', 'Recovered', const Color(0xFF10B981)),
                      ],
                    ),
                    const SizedBox(height: 32),
                    SizedBox(
                        ...
                        LineChartData(
                          ...
                          titlesData: FlTitlesData(
                            ...
                            leftTitles: AxisTitles(
                              sideTitles: SideTitles(
                                ...
                                getTitlesWidget: (value, meta) {
                                  if (value == 40) {
                                    return const Text('0', style: TextStyle(color: AppColors.textLight, fontSize: 11, fontWeight: FontWeight.w500));
                                  }
                                  if (value % 10 == 0 && value >= 50 && value <= 90) {
                                    return Text(
                          ...
                          lineBarsData: [
                            LineChartBarData(
                              ...
                              dotData: FlDotData(
                                show: true,
                                checkToShowDot: (spot, barData) => spot.x == 2, // Dot only on Fri
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildAppointmentItem('Jacob Jones', 'Headache Disease', '09.40 AM', '11', hasRedDot: true),
                    _buildAppointmentItem('Jenny Wilson', 'Abdominal Pain', '10.40 AM', '43'),
                    _buildAppointmentItem('Jacob Jones', 'Swelling', '11.20 AM', '11'),
                    _buildAppointmentItem('Jacob Jones', 'Cardiology', '12.10 AM', '41'),
                  ],
                ),
              ),
              const SizedBox(height: 32),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildDoctorScheduleItem('DR. Johan Henry', 'General Practitioners', true, '', '60'),
                    _buildDoctorScheduleItem('DR. David Cooper', 'Cardiology', true, '', '59'),
                    _buildDoctorScheduleItem('DR. Brooklyn Simmons', 'Dermatology', false, 'Available at\n2.30 PM', '44'),
                    _buildDoctorScheduleItem('DR. Theresa Webb', 'Pediatrics', false, 'Available at\n2.30 PM', '61'),
                  ],
                ),
              ),
              const SizedBox(height: 32),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildPolyclinicBar('80', 'General', 140, const Color(0xFF007A8A)),
                        _buildPolyclinicBar('50', 'Pediatrics', 100, const Color(0xFF389EA8)),
                        _buildPolyclinicBar('40', 'Cardiology', 85, const Color(0xFF6AB1B8)),
                        _buildPolyclinicBar('30', 'Dermatology', 70, const Color(0xFFB2D4D8)),
                      ],
                    ),
                    const SizedBox(height: 32),
                        ...
                        Expanded(
                          child: Text.rich(
                            const TextSpan(
                              ...
                              style: TextStyle(color: AppColors.textSecondary, fontSize: 12, height: 1.5, fontWeight: FontWeight.normal),
                              children: [
                                TextSpan(
                                  text: '120 to 200 ',
  ...
  Widget _buildAppointmentItem(String name, String dept, String time, String avatarId, {bool hasRedDot = false}) {
    return Padding(
  ...
  Widget _buildDoctorScheduleItem(String name, String dept, bool available, String availableText, String avatarId) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 16.0),
      child: Row(
        children: [
          ...
          if (available)
            Container(
              ...
              child: const Text(
                'Available', 
                style: TextStyle(color: AppColors.success, fontWeight: FontWeight.w500, fontSize: 12)
              ),
            )
          else
            Text(
