...
class SelectDepartmentScreen extends StatefulWidget {
  ...
  const SelectDepartmentScreen({super.key, this.initialSelection});
...
class _SelectDepartmentScreenState extends State<SelectDepartmentScreen> {
  ...
  void initState() {
    super.initState();
    _selectedDepartment = widget.initialSelection;
  }
        ...
        children: [
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected = deptName == _selectedDepartment;

                      return InkWell(
                        onTap: () => setState(() => _selectedDepartment = deptName),
                        child: Padding(
          ...
          Container(
            ...
            child: GestureDetector(
              onTap: () => Navigator.pop(context, _selectedDepartment),
              child: Container(
